...
mat gini=gini' 
matrix C=[gini[2..., 1...]]  	
putexcel set "${excel}\reportJanuary272022.xlsx", sheet("1.2") modify 
...
graph export "${graficos}//graph05.png", width(1000) replace
